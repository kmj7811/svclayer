...
#ifndef LE_BUTTONGPIO33_INTERFACE_H_INCLUDE_GUARD
#define LE_BUTTONGPIO33_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_buttonGpio33_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio33_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio33_SetServerDisconnectHandler
(
    le_buttonGpio33_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio33_DisconnectService
(
    void
);
...
typedef enum
{
    LE_BUTTONGPIO33_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_BUTTONGPIO33_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_buttonGpio33_Polarity_t;
...
typedef enum
{
    LE_BUTTONGPIO33_EDGE_NONE = 0,
        ///< No edge detection
    LE_BUTTONGPIO33_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_BUTTONGPIO33_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_BUTTONGPIO33_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
le_buttonGpio33_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_buttonGpio33_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_buttonGpio33_ChangeEventHandler* le_buttonGpio33_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_BUTTONGPIO33_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_BUTTONGPIO33_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_BUTTONGPIO33_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_buttonGpio33_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_buttonGpio33_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_SetInput
(
    le_buttonGpio33_Polarity_t polarity
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_SetPushPullOutput
(
    le_buttonGpio33_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_SetTriStateOutput
(
    le_buttonGpio33_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_SetOpenDrainOutput
(
    le_buttonGpio33_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_buttonGpio33_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio33_ChangeEventHandlerRef_t le_buttonGpio33_AddChangeEventHandler
(
    le_buttonGpio33_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    le_buttonGpio33_ChangeCallbackFunc_t handlerPtr,
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_buttonGpio33_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio33_RemoveChangeEventHandler
(
    le_buttonGpio33_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_SetEdgeSense
(
    le_buttonGpio33_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio33_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio33_Edge_t le_buttonGpio33_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio33_Polarity_t le_buttonGpio33_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio33_PullUpDown_t le_buttonGpio33_GetPullUpDown
(
    void
);

#endif // LE_BUTTONGPIO33_INTERFACE_H_INCLUDE_GUARD