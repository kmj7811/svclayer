...
#ifndef LE_BUTTONGPIO32_INTERFACE_H_INCLUDE_GUARD
#define LE_BUTTONGPIO32_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_buttonGpio32_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio32_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio32_SetServerDisconnectHandler
(
    le_buttonGpio32_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio32_DisconnectService
(
    void
);
...
typedef enum
{
    LE_BUTTONGPIO32_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_BUTTONGPIO32_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_buttonGpio32_Polarity_t;
...
typedef enum
{
    LE_BUTTONGPIO32_EDGE_NONE = 0,
        ///< No edge detection
    LE_BUTTONGPIO32_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_BUTTONGPIO32_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_BUTTONGPIO32_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
le_buttonGpio32_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_buttonGpio32_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_buttonGpio32_ChangeEventHandler* le_buttonGpio32_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_BUTTONGPIO32_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_BUTTONGPIO32_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_BUTTONGPIO32_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_buttonGpio32_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_buttonGpio32_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_SetInput
(
    le_buttonGpio32_Polarity_t polarity
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_SetPushPullOutput
(
    le_buttonGpio32_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_SetTriStateOutput
(
    le_buttonGpio32_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_SetOpenDrainOutput
(
    le_buttonGpio32_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_buttonGpio32_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio32_ChangeEventHandlerRef_t le_buttonGpio32_AddChangeEventHandler
(
    le_buttonGpio32_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    le_buttonGpio32_ChangeCallbackFunc_t handlerPtr,
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_buttonGpio32_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio32_RemoveChangeEventHandler
(
    le_buttonGpio32_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_SetEdgeSense
(
    le_buttonGpio32_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio32_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio32_Edge_t le_buttonGpio32_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio32_Polarity_t le_buttonGpio32_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio32_PullUpDown_t le_buttonGpio32_GetPullUpDown
(
    void
);

#endif // LE_BUTTONGPIO32_INTERFACE_H_INCLUDE_GUARD