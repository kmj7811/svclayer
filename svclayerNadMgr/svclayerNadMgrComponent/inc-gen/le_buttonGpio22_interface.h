...
#ifndef LE_BUTTONGPIO22_INTERFACE_H_INCLUDE_GUARD
#define LE_BUTTONGPIO22_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_buttonGpio22_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio22_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio22_SetServerDisconnectHandler
(
    le_buttonGpio22_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio22_DisconnectService
(
    void
);
...
typedef enum
{
    LE_BUTTONGPIO22_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_BUTTONGPIO22_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_buttonGpio22_Polarity_t;
...
typedef enum
{
    LE_BUTTONGPIO22_EDGE_NONE = 0,
        ///< No edge detection
    LE_BUTTONGPIO22_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_BUTTONGPIO22_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_BUTTONGPIO22_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
le_buttonGpio22_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_buttonGpio22_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_buttonGpio22_ChangeEventHandler* le_buttonGpio22_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_BUTTONGPIO22_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_BUTTONGPIO22_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_BUTTONGPIO22_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_buttonGpio22_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_buttonGpio22_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_SetInput
(
    le_buttonGpio22_Polarity_t polarity
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_SetPushPullOutput
(
    le_buttonGpio22_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_SetTriStateOutput
(
    le_buttonGpio22_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_SetOpenDrainOutput
(
    le_buttonGpio22_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_buttonGpio22_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio22_ChangeEventHandlerRef_t le_buttonGpio22_AddChangeEventHandler
(
    le_buttonGpio22_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    le_buttonGpio22_ChangeCallbackFunc_t handlerPtr,
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_buttonGpio22_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_buttonGpio22_RemoveChangeEventHandler
(
    le_buttonGpio22_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_SetEdgeSense
(
    le_buttonGpio22_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_buttonGpio22_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio22_Edge_t le_buttonGpio22_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio22_Polarity_t le_buttonGpio22_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_buttonGpio22_PullUpDown_t le_buttonGpio22_GetPullUpDown
(
    void
);

#endif // LE_BUTTONGPIO22_INTERFACE_H_INCLUDE_GUARD